-- MediaItem 0
insert into MediaItem ( mediaType, url) values ( 'IMAGE', 'http://61mg.com/wp-content/uploads/2014/07/Kirti-Reddy.jpg')
-- MediaItem 1
insert into MediaItem ( mediaType, url) values ( 'IMAGE', 'http://photos3.meetupstatic.com/photos/member/a/b/0/6/highres_160963782.jpeg')
-- MediaItem 2
...
-- ShowData 1
insert into ShowData ( event_id, venue_id) values ( 1, 1);
...
-- ShowData 2
insert into ShowData ( event_id, venue_id) values ( 1, 2);
...
-- ShowData 3
insert into ShowData ( event_id, venue_id) values ( 2, 1);
...
-- ShowData 4
insert into ShowData ( event_id, venue_id) values ( 2, 2);
...
--show 5
insert into ShowData ( event_id, venue_id) values ( 3, 3);
...
-- ShowData 6
insert into ShowData ( event_id, venue_id) values ( 1, 5);
