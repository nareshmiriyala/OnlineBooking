...
/**
 * Metric data for a ShowData. Contains the identifier for the ShowData to identify it,
 * in addition to the event name, the venue name and capacity, and the metric
 * data for the performances of the ShowData.
 * 
...
class ShowMetric {
	...
	public ShowMetric(ShowData show, Map<Long, Long> occupiedCounts) {
