...
public class MetricsService {
    ...
    private List<ShowMetric> retrieveMetricsFromShows(List<ShowData> shows,
    ...
    private List<ShowData> retrieveShows() {
        TypedQuery<ShowData> showQuery = entityManager
            .createQuery("select DISTINCT s from ShowData s JOIN s.performances p WHERE p.date > current_timestamp", ShowData.class);
