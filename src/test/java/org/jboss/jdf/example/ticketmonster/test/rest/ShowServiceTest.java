package org.jboss.jdf.example.ticketmonster.test.rest;
...
public class ShowServiceTest {
    ...
    public void testGetShowById() {
        ...
        ShowData show = showService.getSingleInstance(1l);
        assertNotNull(show);
    ...
    public void testPagination() {
        ...
        List<ShowData> shows = showService.getAll(queryParameters);
        assertNotNull(shows);
    ...
    public void testGetShowByPerformance() {
        ...
        ShowData show = showService.getShowByPerformance(1l);
        assertNotNull(show);
        assertEquals("Roy Thomson Hall", show.getVenue().getName());
        assertEquals("Rock concert of the decade", show.getEvent().getName());
    }
